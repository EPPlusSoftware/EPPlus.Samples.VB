    ...
    Public Class CreateASimpleWorkbook
        ...
        Public Shared Sub Run()
            ...
            Using package = New ExcelPackage()
                ...
                Dim worksheet = package.Workbook.Worksheets.Add("Inventory")
                'Add the headers
                ...
                Using range = worksheet.Cells(1, 1, 1, 5)
                ...
                Dim xlFile = FileUtil.GetCleanFileInfo("1.01-GettingStarted.xlsx")
